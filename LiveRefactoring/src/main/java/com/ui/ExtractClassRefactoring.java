...
import static com.ui.ExtractClassPreviewProcessor.PsiElementChange.ChangeType.*;
...
public class ExtractClassRefactoring {
    ...
    private static final String UPDATED_EXTRACTED_FIELD_ASSIGMENT = IntelliJDeodorantBundle.message("god.class.preview.updated.extracted.field.assignment");
