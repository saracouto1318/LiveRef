...
public class ExtractClassPreviewProcessor {
     ...
     */
    private final List<PsiMethodComparingPair> methodComparingList = new ArrayList<>();

    /**
     * For each updated {@link PsiMethod}, stores all changes applied to the method or null if there are no changes.
     */
    private final Map<PsiMethod, ArrayList<PsiElementComparingPair>> methodElementsComparingMap = new LinkedHashMap<>();

    /**
     * Stores class-level changes (field adding/removing, etc).
     */
    private final List<PsiElementChange> psiElementChanges = new ArrayList<>();
    ...
    private final Map<PsiElement, PsiElement> updatedSourceElementsToInitial = new HashMap<>();
    ...
    /**
     * Removes a method comparison if there are no changes.
     */
    ...
    public static class PsiMethodComparingPair {
        ...
        private final PsiMethod initialPsiMethod;
        private final PsiMethod updatedPsiMethod;
        /**
         ...
         */
        private final boolean forceComparing;
    ...
    public static class PsiElementComparingPair {
        private final PsiElement initialPsiElement;
        private final PsiElement updatedPsiElement;
