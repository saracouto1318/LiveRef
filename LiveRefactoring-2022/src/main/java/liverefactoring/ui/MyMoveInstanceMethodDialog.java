 ...
 * @author ven
 */
public class MyMoveInstanceMethodDialog extends MoveInstanceMethodDialogBase {
    ...
    public MyMoveInstanceMethodDialog(final PsiMethod method,
                                      final PsiVariable[] variables) {
        super(method, variables, "Move Instance Method", false);
        init();
    }
