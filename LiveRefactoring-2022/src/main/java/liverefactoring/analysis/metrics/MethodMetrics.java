...
public class MethodMetrics {
    ...
    public double halsteadLength = 0;
    public double halsteadVocabulary = 0;
    ...
    public MethodMetrics(PsiClass _class, PsiMethod method, boolean isConstructor) throws Exception {
        this._class = _class;
        this.method = method;
    ...
    private void initializeMetrics() throws Exception {
        ...
        if (this.method != null) {
            ...
            if(this.lackOfCohesionInMethod > 1.0) this.lackOfCohesionInMethod = 1.0;

            if (this.numberLinesOfCode > ThresholdsCandidates.extractMethodLinesCode)
                this.isLong = true;
